...
export const getAllPizzas = () => async dispatch => {
  ...
  try {
    const response = await axios.get(
      "http://locahost:3000/api/pizzas/getallpizzas"
    );
...
export const addPizza = pizza => async dispatch => {
  ...
  try {
    const response = await axios.post(
      "http://locahost:3000/api/pizzas/addpizza",
      { pizza: pizza }
    );
    console.log(response);
...
export const getPizzaById = pizzaid => async dispatch => {
  ...
  try {
    const response = await axios.post(
      "http://locahost:3000/api/pizzas/getpizzabyid",
      { pizzaid: pizzaid }
    );
    console.log(response);
...
export const updatePizza = updatedPizza => async dispatch => {
  ...
  try {
    const response = await axios.post(
      "http://locahost:3000/api/pizzas/updatepizza",
...
export const deletePizza = pizzaid => async dispatch => {
  ...
  try {
    const response = await axios.post(
      "http://locahost:3000/api/pizzas/deletepizza",
      { pizzaid: pizzaid }
    );
    console.log(response);
